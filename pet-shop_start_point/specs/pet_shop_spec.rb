...
# use double loop! and use first navigate point in first loop and then second symbol/hash location in the second inner loop

# having either arthur work or Nil work breaks the other :( cant find a good solution)
